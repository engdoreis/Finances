    ...
    def __init__(self, *args):
        ...
        if (len(args) == 2 and isinstance(args[0], pd.DataFrame)):
            ...
            self.buildTable(p.equity, p.cost, p.expense, p.paperProfit, p.realizedProfit, p.div, p.profit,\
                            p.cum_cdb, p.ibov, p.sp500, p.currency, p.exchangeRatio)

    def buildTable(self, equity, cost, expense, paperProfit, profit, div, totalProfit, selic, ibov, sp500, currency='$', exchangeRatio=0.22):
