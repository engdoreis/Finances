...
class StatusInvest:
    def __init__(self, inFile):
        ...
        self.orders = self.orders[['Date', 'Category', 'Paper', 'Type', 'Qty', 'Value', 'Corretora', 'Corretagem', 'Fee', 'Impostos', 'IRRF']]
        self.orders.columns = ['Data operação', 'Categoria', 'Código Ativo', 'Operação C/V', 'Quantidade', 'Preço unitário', 'Corretora', 'Corretagem', 'Taxas', 'Impostos', 'IRRF']
