...
class PDFPage:
    ...
    def finish(self):
        self.dtFrame.to_csv(self.output)
...
def ReadOrders():
    ...
    print('Getting tickers names...', end='\n')
    ...
    oOrg.dtFrame[['Paper', 'Date', 'Value', 'Qty', 'Type', 'Category', 'Fee', 'Company']].to_csv(outputDir+'/operations_2.csv')
